<%@page import="com.vignesh.tradingApplication.model.Portfolio"%>
	...
	<div class="content1">
		<table>
			<tr>
             ...
             <% ArrayList<Portfolio> al= (ArrayList<Portfolio>)request.getAttribute("portlist");
            
            for(Portfolio a:al){
            	out.println("<tr>");
            	out.println("<td>"+a.getId()+"</td>");
            	out.println("<td>"+a.getQuantity()+"</td>");
            	out.println("<td>"+a.getAveragePrice()+"</td>");
            	out.println("<td>"+a.getTotalInvestment()+"</td>");
			...
			<c:if test="${not empty portlist}">
				<c:forEach items="${portlist}" var="user">
					<tr>
						<td><c:out value="${user.id}" /></td>
						<td><c:out value="${user.quantity}" /></td>
						<td><c:out value="${user.averagePrice}" /></td>
						<td><c:out value="${user.totalInvestment}" /></td>
