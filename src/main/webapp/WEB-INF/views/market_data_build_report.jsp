...
<form action="/marketdata/addmarket" method="post">
<table>
...
<td>High price</td>
<td><input type="number" name="highPrice" id="hprice" required="required"></td>
...
<td>Low Price</td>
<td><input type="number" name="lowPrice" id="lprice" required="required"></td>

</tr>
<tr>
<td>open Price</td>
<td><input type="number" name="openPrice" id="oprice" required="required"></td>

</tr>
<tr>
<td>close Price</td>
<td><input type="number" name="closePrice" id="clprice" required="required"></td>
...
<tr>
<td>Volume</td>
<td><input type="number" name="volume" id="vol" required="required"></td>
