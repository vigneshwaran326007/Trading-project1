...
<form action="/report/userreport" method="get">
<table>

<tr>

<td>Start Date</td>
<td><input type="date" name="date1" id="date1" required="required"></td>

</tr>
<tr>

<td>End Date</td>
<td><input type="date" name="date2" id="date2" required="required"></td>
...
<td></td>
<td><input type="submit" value="Generate" id="log"></td>
