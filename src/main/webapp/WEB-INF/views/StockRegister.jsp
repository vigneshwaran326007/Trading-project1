...
<h1>stock register page</h1>

 

<div class="content">

<form action="/stocks/addstock" method="post">
<table>

<tr>

<td>Symbol</td>
<td><input type="text" name="symbol" id="sym" required="required"></td>

</tr>
<tr>

<td>Company Name</td>
<td><input type="text" name="companyName" id="cname" required="required"></td>
...
<td>Current Price</td>
<td><input type="text" name="currentPrice" id="cprice" required="required"></td>
