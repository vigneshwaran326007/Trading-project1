<%@page import="com.vignesh.tradingApplication.model.Transaction"%>
	...
	<div class="content1">
		<table>
			<tr>
			 ...
			 <% ArrayList<Transaction> al= (ArrayList<Transaction>)request.getAttribute("translist");
            
            for(Transaction a:al){
            	out.println("<tr>");
            	out.println("<td>"+a.getId()+"</td>");
            	out.println("<td>"+a.getQuantity()+"</td>");
            	out.println("<td>"+a.getPrice()+"</td>");
            	out.println("<td>"+a.getTransactionType()+"</td>");
            	out.println("<td>"+a.getUser()+"</td>");
            	out.println("<td>"+a.getStock()+"</td>");
            	out.println("<td>"+a.getTransactionDate()+"</td>");
