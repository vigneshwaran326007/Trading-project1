<%@page import="com.vignesh.tradingApplication.model.Stock"%>
    ...
    <div class="content1">
        <table>
            <tr>
             ...
             <% ArrayList<Stock> al= (ArrayList<Stock>)request.getAttribute("stocklist");
            
            for(Stock a:al){
            	out.println("<tr>");
            	out.println("<td>"+a.getId()+"</td>");
            	out.println("<td>"+a.getSymbol()+"</td>");
            	out.println("<td>"+a.getCompanyName()+"</td>");
            	out.println("<td>"+a.getCurrentPrice()+"</td>");
            ...
            <c:if test="${not empty stocklist}">
                <c:forEach items="${stocklist}" var="user">
                    <tr>
                        <td><c:out value="${user.id}" /></td>
                        <td><c:out value="${user.symbol}" /></td>
                        <td><c:out value="${user.companyName}" /></td>
                        <td><c:out value="${user.currentPrice}" /></td>
