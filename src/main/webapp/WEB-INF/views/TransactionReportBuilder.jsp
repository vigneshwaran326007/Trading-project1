...
<td>User id</td>
<td><input type="number" name="user" id="userid" required="required"></td>
...
<td><input type="text" name="transactionType" id="transtype" required="required"></td>
...
<tr>
<td>Price</td>
<td><input type="number" name="price" id="price" required="required"></td>

</tr>
<tr>
<td>Transaction Date</td>
<td><input type="date" name="transactionDate" id="date" required="required"></td>
